...
class InstallCommand extends Command
{
    ...
    public function handle()
    {
        ...
        $this->comment('Generating Admin Resource...');
        $this->callSilent('nova:resource', ['name' => 'Admin']);
        copy(__DIR__.'/stubs/user-resource.stub', app_path('Nova/Admin.phpp'));
    ...
    protected function setAppNamespace()
    {
        ...
        $this->setAppNamespaceOn(app_path('Nova/Admin.phpp'), $namespace);
